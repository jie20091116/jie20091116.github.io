$("#music")
	.append('<div id="xplayer" style="background: rgba(0, 0, 0, 0.50);"><div class="player"><div class="info"><div class="coverbg" style=""></div><div class="songstyle"><i class="fa fa-music"></i> <span class="song"><span title=""></span><span></div><div class="artiststyle"><i class="fa fa-user"></i> <span class="artist"><span title=""></span></span></div><div class="albumstyle"><i class="fa fa-folder"></i> <span class="album"><span title=""></span></span></div><div class=\"timestyle\"><i class=\"fa fa-clock-o\"></i> <span class=\"time\">00:00 / 00:00</span></div></div><div class="cover"></div><div class="status"><i class="play fa fa-play" title="播放"></i><i class="pause fa fa-pause" title="暂停"></i></div><div class="control"><i class="aprev fa fa-fast-backward" title="上一专辑"></i><i class="prev fa fa-backward" title="上一首"></i><i class="next fa fa-forward" title="下一首"></i><i class="anext fa fa-fast-forward" title="下一专辑"></i></div><div class="foot"><div class="volumecontrol"><div class="volume fa fa-volume-up"></div><div class="volumeprogress"><div class="progressbg"><div class="progressbg1"></div><div class="ts"></div></div></div></div><div class="playprogress"><div class="progressbg"><div class="progressbg1"></div><div class="progressbg2"></div><div class="ts"></div></div></div><div class="switch-ksclrc"><i class=\"random fa fa-toggle-on\" title="关闭歌词"></i></div><div class="qhms"><i class="random fa fa-retweet" title="专辑循环"></i></div><div class="switch-playlist"><i class="fa fa-list-ul" title="播放列表"></i></div></div></div><div class="playlist"><div class="playlist-bd"><div class="album-list"><div class="musicheader"></div><div class="list"></div></div><div class="song-list"><div class="musicheader"><i class="fa fa-angle-right"></i><span></span></div><div class="list">				<span></span></div></div></div></div><div class="switch-player" style="background: rgba(0, 0, 0, 0.50);"><i class="fa fa-angle-right" style="margin-top: 50%;"></i></div></div><div id="Tips" class=""></div><div id="Ksc" class=""></div><div id="Lrc" class=""></div>');
...
var key = $("#music")
	.attr("key"); //key密钥
consolelog('SG' + XPLAYER_VERSION + ' BY:SHANGUI', api);
$("head")
...
$artist.html("<span>SG</span>");
$cover.html("<img src='https://q1.qlogo.cn/g?b=qq&nk=2491000000&s=140'><div id='pdyf1' class='note' style='color: #ff572299;'><i class='fa fa-music' aria-hidden='true'></i></div><div id='pdyf2' class='note' style='color: #1e9fff96;'><i class='fa fa-music' aria-hidden='true'></i></div><div id='pdyf3' class='note' style='color: #00968885;'><i class='fa fa-music' aria-hidden='true'></i></div>");
$coverbg.css({
		background: "url(https://q1.qlogo.cn/g?b=qq&nk=2491000000&s=140)"
	});
playList = {
	creat: {
		album: function() {
...
function netmusic() {
	...
	d.onerror = function() {
		d.src = "https://q1.qlogo.cn/g?b=qq&nk=2491000000&s=140";
		$(".cover", $player)
			.html("<img src='" + d.src + "'><div id='pdyf1' class='note' style='color: #ff572299;'><i class='fa fa-music' aria-hidden='true'></i></div><div id='pdyf2' class='note' style='color: #1e9fff96;'><i class='fa fa-music' aria-hidden='true'></i></div><div id='pdyf3' class='note' style='color: #00968885;'><i class='fa fa-music' aria-hidden='true'></i></div>");
		$coverbg.css({
	...
	//飘动音符
	if (playerinfo.showNotes == 0) {
	    $("#pdyf1,#pdyf2,#pdyf3", $player).remove();
	};
	if (first == 1) {
		first = 2;
...
function playerColor() {
	...
	$(".info,.control,.status , .artiststyle, .albumstyle, a,.playlist .list li,.musicheader a,.playlist,.musicheader", $player).css({
